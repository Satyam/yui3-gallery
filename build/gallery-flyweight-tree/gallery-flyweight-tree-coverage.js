...
FWNode = Y.Base.create(
	...
	[],
	{
		...
		_getHTML: function(index, nSiblings, depth) {
			...
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getHTML", 402);
...
this.forEachChild( function (fwNode, index, array) {
						_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 6)", 423);
...
return Lang.sub(templ, attrs);
		...
		_slideTo: function (node) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_slideTo", 456);
...
this._stateProxy = node;
		...
		**/
		forEachChild: function(fn, scope) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forEachChild", 470);
...
YArray.each(children, function (node, index, array) {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 7)", 476);
...
return ret;
		...
		_expandedGetter: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedGetter", 494);
...
return this._node.expanded !== false;
		...
		_expandedSetter: function (value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedSetter", 506);
...
el.replaceClass(CNAME_EXPANDED, CNAME_COLLAPSED);
		...
		_loadDynamic: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_loadDynamic", 534);
...
root.get('dynamicLoader').call(root, self, Y.bind(self._dynamicLoadReturn, self));
		...
		_dynamicLoadReturn: function (response) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoadReturn", 547);
...
Y.one('#' + node.id).replaceClass(CNAME_LOADING, (node.isLeaf?CNAME_NOCHILDREN:CNAME_EXPANDED));
		...
		_renderChildren: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_renderChildren", 569);
...
this.forEachChild(function (fwNode, index, array) {
				_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 8)", 574);
...
Y.one('#' + node.id + ' .' + CNAME_CHILDREN).setContent(s);
		 ...
		 */
		hold: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "hold", 585);
...
return (this._node._held = this);
		 ...
		 */
		release: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "release", 595);
...
return this;
		 ...
		 */
		getParent: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getParent", 607);
...
return (node?this._root._poolFetch(node):null);
		...
		getNextSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getNextSibling", 618);
...
return this._root._poolFetch(siblings[index]);
		...
		getPreviousSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getPreviousSibling", 634);
...
return this._root._poolFetch(siblings[index]);
		 ...
		 */
		toggle: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "toggle", 649);
...
return this;
		 ...
		 */
		isRoot: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "isRoot", 658);
...
return this._root._tree === this._node;
		...
		*/
		_getStateVal : function(name) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getStateVal", 670);
...
return this._state.get(name, VALUE);
		...
		*/
		_setStateVal : function(name, value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_setStateVal", 690);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 691);
var node = this._node;
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 692);
if (this._state.get(name, BYPASS_PROXY) || this._state.get(name, 'initializing') || !node) {
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 693);
	...
	},
	{
		...
		ATTRS: {
			...
			root: {
				...
				readOnly: true,
				getter: function() {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 790);
...
return this._root;
			...
			depth: {
				...
				readOnly: true,
				getter: function () {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 838);
...
while (node._parent) {
						_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 842);
count += 1;
