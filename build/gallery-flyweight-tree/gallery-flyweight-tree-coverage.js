...
self.fire = (function (original) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 6)", 226);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 227);
return function (type, ev) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 7)", 227);
...
return original.call(self, type, ev);
         ...
         */
        expandAll: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "expandAll", 248);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 249);
this._forSomeINode(function(iNode) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 8)", 249);
...
this._poolReturn(this._poolFetch(iNode).set(EXPANDED, true));
        ...
        _afterDomEvent: function(ev) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_afterDomEvent", 263);
...
fwNode.fire(ev.type.split(':')[1], {domEvent:ev.domEvent});
        ...
        _getTypeString: function (iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getTypeString", 277);
...
throw "Node contains unknown type";
            ...
            _yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 286);
return type;
        },
        /**
        ...
        _poolFetch: function(iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolFetch", 298);
...
return this._createNode(iNode);
        ...
        _poolReturn: function (fwNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolReturn", 324);
...
pool.push(fwNode);
        ...
        _createNode: function (iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_createNode", 345);
...
if (Lang.isString(Type)) {
                _yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 349);
Type = Y[Type];
            }
...
return null;
         ...
         */
        getRoot: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getRoot", 372);
...
return this._poolFetch(this._tree);
         ...
         */
        _getHTML: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getHTML", 382);
...
root.forSomeChildren( function (fwNode, index, array) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 9)", 385);
...
return s;
        ...
        _findINodeByElement: function(el) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_findINodeByElement", 398);
...
var id = el.ancestor(DOT + FWNode.CNAME_NODE, true).get('id'),
                found = null,
                scan = function (iNode) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "scan", 401);
...
return null;
        ...
        _poolFetchFromEvent: function (ev) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolFetchFromEvent", 423);
...
return null;
        ...
        _forSomeINode: function(fn, scope) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_forSomeINode", 442);
...
var loop = function(iNode, depth) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "loop", 444);
...
return YArray.some(iNode.children || [], function(childINode, index) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 10)", 445);
...
return loop(this._tree, 0);
        ...
        forSomeNodes: function (fn, scope) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forSomeNodes", 466);
...
var forOneLevel = function (fwNode, depth) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forOneLevel", 469);
...
fwNode.forSomeChildren(function (fwNode, index, array) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 11)", 470);
...
return forOneLevel(this.getRoot(), 1);
        ...
        _focusedNodeGetter: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusedNodeGetter", 485);
...
return this._poolFetch(this._focusedINode);
        ...
        _focusedNodeSetter: function (value) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusedNodeSetter", 495);
...
return Y.Attribute.INVALID_VALUE;
        ...
        _focusOnINode: function (iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusOnINode", 510);
...
this._focusedINode = iNode;
        ...
        _dynamicLoaderSetter: function (value) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoaderSetter", 537);
...
this._forSomeINode(function(iNode) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 12)", 542);
...
FWNode = Y.Base.create(
	...
	[],
	{
        ...
        initializer: function (cfg) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "initializer", 647);
...
this._root = cfg.root;
		...
		_getHTML: function(index, nSiblings, depth) {
			...
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getHTML", 665);
...
templ = superConstructor.TEMPLATE;
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 678);
...
this.forSomeChildren( function (fwNode, index, array) {
						_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 13)", 686);
...
nodeClasses.push(CNAME_EXPANDED);
					...
					_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 691);
...
return Lang.sub(templ, attrs);
		...
		_slideTo: function (iNode) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_slideTo", 721);
...
this._stateProxy = iNode;
		...
		**/
		forSomeChildren: function(fn, scope) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forSomeChildren", 735);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 736);
var root = this._root,
				children = this._iNode.children,
				child, ret;
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 739);
scope = scope || this;
...
YArray.some(children, function (iNode, index, array) {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 14)", 741);
...
return ret;
		...
		_expandedGetter: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedGetter", 759);
...
return this._iNode.expanded !== false;
		...
		_expandedSetter: function (value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedSetter", 771);
...
el.set('aria-expanded', String(value));
		...
		_loadDynamic: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_loadDynamic", 800);
...
root.get(DYNAMIC_LOADER).call(root, self, Y.bind(self._dynamicLoadReturn, self));
		...
		_dynamicLoadReturn: function (response) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoadReturn", 813);
...
Y.one('#' + iNode.id).replaceClass(CNAME_LOADING, (iNode.isLeaf?CNAME_NOCHILDREN:CNAME_EXPANDED));
		...
		_renderChildren: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_renderChildren", 835);
...
this.forSomeChildren(function (fwNode, index, array) {
				_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 15)", 840);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 841);
s += fwNode._getHTML(index, array.length, depth + 1);
			});
...
Y.one('#' + iNode.id + ' .' + CNAME_CHILDREN).setContent(s);
		 ...
		 */
		hold: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "hold", 851);
...
return (this._iNode._held = this);
		 ...
		 */
		release: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "release", 861);
...
return this;
		 ...
		 */
		getParent: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getParent", 873);
...
return (iNode?this._root._poolFetch(iNode):null);
		...
		getNextSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getNextSibling", 884);
...
return this._root._poolFetch(siblings[index]);
		...
		getPreviousSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getPreviousSibling", 900);
...
return this._root._poolFetch(siblings[index]);
         ...
         */
        focus: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "focus", 914);
...
return this._root.set(FOCUSED, this);
         ...
         */
        blur: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "blur", 922);
...
return this._root.set(FOCUSED, null);
		 ...
		 */
		toggle: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "toggle", 930);
...
return this.set(EXPANDED, !this.get(EXPANDED));
         ...
         */
        expand: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "expand", 938);
...
return this.set(EXPANDED, true);
         ...
         */
        collapse: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "collapse", 946);
...
return this.set(EXPANDED, false);
		 ...
		 */
		isRoot: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "isRoot", 954);
...
return this._root._tree === this._iNode;
		...
		*/
		_getStateVal : function(name) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getStateVal", 966);
...
return this._state.get(name, VALUE);
		...
		*/
		_setStateVal : function(name, value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_setStateVal", 986);
...
this._state.add(name, VALUE, value);
				...
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 991);
iNode[name] = value;
			}
		}
	},
	{
		...
		ATTRS: {
			...
			root: {
				...
				readOnly: true,
				getter: function() {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 1128);
...
return this._root;
			...
			depth: {
				...
				readOnly: true,
				getter: function () {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 1176);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1177);
var count = 0,
						iNode = this._iNode;
					_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1179);
while (iNode._parent) {
						_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1180);
count += 1;
						_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1181);
iNode = iNode._parent;
					}
					_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1183);
return count-1;
				}
			},
			/**
...
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1200);
