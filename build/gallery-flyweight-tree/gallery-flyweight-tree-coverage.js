...
nodeClasses.push(CNAME_FIRSTCHILD);
			} else {_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 439);
...
return Lang.sub(templ, attrs);
		...
		_slideTo: function (node) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_slideTo", 455);
...
this._stateProxy = node;
		...
		**/
		forEachChild: function(fn, scope) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forEachChild", 469);
...
YArray.each(children, function (node, index, array) {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 7)", 475);
...
return ret;
		...
		_expandedGetter: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedGetter", 493);
...
return this._node.expanded !== false;
		...
		_expandedSetter: function (value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedSetter", 505);
...
el.replaceClass(CNAME_EXPANDED, CNAME_COLLAPSED);
		...
		_loadDynamic: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_loadDynamic", 533);
...
root.get('dynamicLoader').call(root, self, Y.bind(self._dynamicLoadReturn, self));
		...
		_dynamicLoadReturn: function (response) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoadReturn", 545);
...
Y.one('#' + node.id).replaceClass(CNAME_LOADING, (node.isLeaf?CNAME_NOCHILDREN:CNAME_EXPANDED));
		...
		_renderChildren: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_renderChildren", 567);
...
this.forEachChild(function (fwNode, index, array) {
				_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 8)", 572);
...
Y.one('#' + node.id + ' .' + CNAME_CHILDREN).setContent(s);
		 ...
		 */
		hold: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "hold", 583);
...
return (this._node._held = this);
		 ...
		 */
		release: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "release", 593);
...
return this;
		 ...
		 */
		getParent: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getParent", 605);
...
return (node?this._root._poolFetch(node):null);
		...
		getNextSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getNextSibling", 616);
...
return this._root._poolFetch(siblings[index]);
		...
		getPreviousSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getPreviousSibling", 632);
...
return this._root._poolFetch(siblings[index]);
		 ...
		 */
		toggle: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "toggle", 647);
...
return this;
		 ...
		 */
		isRoot: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "isRoot", 656);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 657);
return this._root._tree === this._node;
		...
		*/
		_getStateVal : function(name) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getStateVal", 668);
...
return this._state.get(name, VALUE);
		...
		*/
		_setStateVal : function(name, value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_setStateVal", 688);
	...
	},
	{
		...
		ATTRS: {
			...
			root: {
				...
				readOnly: true,
				getter: function() {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 788);
...
return this._root;
			...
			depth: {
				...
				readOnly: true,
				getter: function () {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 836);
