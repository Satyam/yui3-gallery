...
_yuitest_coverage["gallery-md-model"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@extends Base
**/
	_yuitest_coverfunc("gallery-md-model", "(anonymous 1)", 1);
_yuitest_coverline("gallery-md-model", 26);
"use strict";
	
	_yuitest_coverline("gallery-md-model", 28);
var Lang = Y.Lang,
		YArray = Y.Array,
		YObject = Y.Object,
		EVT_CHANGE = 'change',
	...
	_yuitest_coverline("gallery-md-model", 44);
Y.GalleryModel = Y.Base.create(
		...
		[],
		{
			...
			initializer: function  (cfg) {
				_yuitest_coverfunc("gallery-md-model", "initializer", 74);
_yuitest_coverline("gallery-md-model", 75);
this._values = {};
				_yuitest_coverline("gallery-md-model", 76);
this._loadedValues = {};
				/**
				 ...
				 */
				_yuitest_coverline("gallery-md-model", 85);
this.publish(EVT_CHANGE, {
				 ...
				 */
				_yuitest_coverline("gallery-md-model", 96);
this.publish(EVT_LOADED, {
				 ...
				 * @event saved
				 */
				_yuitest_coverline("gallery-md-model", 104);
this.publish(EVT_SAVED, {
					preventable: false
				});
				_yuitest_coverline("gallery-md-model", 107);
cfg = cfg || {};
				_yuitest_coverline("gallery-md-model", 108);
if (Lang.isObject(cfg.values)) {
					_yuitest_coverline("gallery-md-model", 109);
this.setValues(cfg.values, 'init');
					_yuitest_coverline("gallery-md-model", 110);
this._set(IS_MODIFIED, false);
					_yuitest_coverline("gallery-md-model", 111);
this._set(IS_NEW, true);
					_yuitest_coverline("gallery-md-model", 112);
this._loadedValues = Y.clone(this._values);
			...
			destroy: function (options, callback) {
				_yuitest_coverfunc("gallery-md-model", "destroy", 131);
_yuitest_coverline("gallery-md-model", 132);
if (Lang.isFunction(options)) {
					_yuitest_coverline("gallery-md-model", 133);
callback = options;
					_yuitest_coverline("gallery-md-model", 134);
options = {};
				} else {_yuitest_coverline("gallery-md-model", 135);
if (!options) {
					_yuitest_coverline("gallery-md-model", 136);
options = {};
				}}
				_yuitest_coverline("gallery-md-model", 138);
var self = this,
					finish = function (err) {
						_yuitest_coverfunc("gallery-md-model", "finish", 139);
_yuitest_coverline("gallery-md-model", 140);
if (!err) {
							_yuitest_coverline("gallery-md-model", 141);
YArray.each(self.lists.concat(), function (list) {
								_yuitest_coverfunc("gallery-md-model", "(anonymous 2)", 141);
_yuitest_coverline("gallery-md-model", 142);
list.remove(self, options);
							});

							_yuitest_coverline("gallery-md-model", 145);
Y.GalleryModel.superclass.destroy.call(self);
						}

						_yuitest_coverline("gallery-md-model", 148);
if (Lang.isFunction(callback)) {
							_yuitest_coverline("gallery-md-model", 149);
callback.apply(null, arguments);
						}
					};

				_yuitest_coverline("gallery-md-model", 153);
if (callback || options) {
					_yuitest_coverline("gallery-md-model", 154);
this.sync('delete', options, finish);
				} else {
					_yuitest_coverline("gallery-md-model", 156);
finish();
				}

				_yuitest_coverline("gallery-md-model", 159);
return this;
			},
			/**
			...
			getValue: function (name) {
				_yuitest_coverfunc("gallery-md-model", "getValue", 167);
_yuitest_coverline("gallery-md-model", 168);
return this._values[name];
			 ...
			 */ 
			getValues: function() {
				_yuitest_coverfunc("gallery-md-model", "getValues", 175);
_yuitest_coverline("gallery-md-model", 176);
return Y.clone(this._values);
			...
			setValue: function (name, value, src) {
				_yuitest_coverfunc("gallery-md-model", "setValue", 187);
_yuitest_coverline("gallery-md-model", 188);
var prevVal = this._values[name];
				_yuitest_coverline("gallery-md-model", 189);
if (prevVal !== value && (this._primaryKeys.indexOf(name) === -1 || Lang.isUndefined(prevVal))) {
					_yuitest_coverline("gallery-md-model", 190);
this.fire(EVT_CHANGE, {
			...
			_defSetValue: function (ev) {
				_yuitest_coverfunc("gallery-md-model", "_defSetValue", 204);
_yuitest_coverline("gallery-md-model", 205);
var self = this;
				_yuitest_coverline("gallery-md-model", 206);
if (ev.name) {
					_yuitest_coverline("gallery-md-model", 207);
self._values[ev.name] = ev.newVal;
					_yuitest_coverline("gallery-md-model", 208);
self._set(IS_MODIFIED, true);
				} else {
					_yuitest_coverline("gallery-md-model", 210);
YObject.each(ev.newVals, function (value, name) {
						_yuitest_coverfunc("gallery-md-model", "(anonymous 3)", 210);
_yuitest_coverline("gallery-md-model", 211);
self.setValue(name, value, ev.src);
			...
			setValues: function (values, src) {
				_yuitest_coverfunc("gallery-md-model", "setValues", 221);
_yuitest_coverline("gallery-md-model", 222);
var self = this,
					prevVals = {};
					
				_yuitest_coverline("gallery-md-model", 225);
YObject.each(values, function (value, name) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 4)", 225);
_yuitest_coverline("gallery-md-model", 226);
prevVals[name] = self.getValue(name);
				});
				_yuitest_coverline("gallery-md-model", 228);
this.fire(EVT_CHANGE, {
					newVals:values,
					prevVals:prevVals,
					src: src
			...
			getChangedValues: function() {
				_yuitest_coverfunc("gallery-md-model", "getChangedValues", 240);
_yuitest_coverline("gallery-md-model", 241);
var changed = {}, 
					prev, 
					loaded = this._loadedValues;

				_yuitest_coverline("gallery-md-model", 245);
YObject.each(this._values, function (value, name) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 5)", 245);
_yuitest_coverline("gallery-md-model", 246);
prev = loaded[name];
					_yuitest_coverline("gallery-md-model", 247);
if (prev !== value) {
						_yuitest_coverline("gallery-md-model", 248);
changed[name] = {prevVal:prev, newVal: value};
					}
				});
				_yuitest_coverline("gallery-md-model", 251);
return changed;
			},
			/**
			...
			getPKValues: function () {
				_yuitest_coverfunc("gallery-md-model", "getPKValues", 258);
_yuitest_coverline("gallery-md-model", 259);
var pkValues = {},
					self = this;
				_yuitest_coverline("gallery-md-model", 261);
YArray.each(self._primaryKeys, function (name) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 6)", 261);
_yuitest_coverline("gallery-md-model", 262);
pkValues[name] = self._values[name];
				});
				_yuitest_coverline("gallery-md-model", 264);
return pkValues;
			},
			/**
			...
			**/
			getAsHTML: function (name) {
				_yuitest_coverfunc("gallery-md-model", "getAsHTML", 274);
_yuitest_coverline("gallery-md-model", 275);
var value = this.getValue(name);
				_yuitest_coverline("gallery-md-model", 276);
return Y.Escape.html(Lang.isValue(value) ? String(value) : '');
			...
			getAsURL: function (name) {
				_yuitest_coverfunc("gallery-md-model", "getAsURL", 289);
_yuitest_coverline("gallery-md-model", 290);
var value = this.getValue(name),
					url = [];
				_yuitest_coverline("gallery-md-model", 292);
if (name) {
					_yuitest_coverline("gallery-md-model", 293);
return encodeURIComponent(Lang.isValue(value) ? String(value) : '');
				} 
				_yuitest_coverline("gallery-md-model", 295);
YObject.each(value, function (value, name) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 7)", 295);
_yuitest_coverline("gallery-md-model", 296);
if (Lang.isValue(value)) {
						_yuitest_coverline("gallery-md-model", 297);
url.push(encodeURIComponent(name) + '=' + encodeURIComponent(value));
					}
				});
				_yuitest_coverline("gallery-md-model", 300);
return url.join('&');
			},
			...
			_defDataLoaded: function (ev) {
				_yuitest_coverfunc("gallery-md-model", "_defDataLoaded", 309);
_yuitest_coverline("gallery-md-model", 310);
var self = this;
				_yuitest_coverline("gallery-md-model", 311);
self.setValues(ev.parsed, ev.src);
				_yuitest_coverline("gallery-md-model", 312);
self._set(IS_MODIFIED, false);
				_yuitest_coverline("gallery-md-model", 313);
self._set(IS_NEW, false);
				_yuitest_coverline("gallery-md-model", 314);
self._loadedValues = Y.clone(self._values);
			...
			**/
			load: function (options, callback) {
				_yuitest_coverfunc("gallery-md-model", "load", 337);
_yuitest_coverline("gallery-md-model", 338);
var self = this;

				_yuitest_coverline("gallery-md-model", 340);
if (Lang.isFunction(options)) {
					_yuitest_coverline("gallery-md-model", 341);
callback = options;
					_yuitest_coverline("gallery-md-model", 342);
options = {};
				} else {_yuitest_coverline("gallery-md-model", 343);
if (!options) {
					_yuitest_coverline("gallery-md-model", 344);
options = {};
				}}

				_yuitest_coverline("gallery-md-model", 347);
self.sync('read', options, function (err, response) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 8)", 347);
_yuitest_coverline("gallery-md-model", 348);
var facade = {
							options : options,
							response: response,
							src: 'load'
					...
					_yuitest_coverline("gallery-md-model", 354);
if (err) {
						_yuitest_coverline("gallery-md-model", 355);
facade.error = err;

						_yuitest_coverline("gallery-md-model", 357);
self.fire(EVT_ERROR, facade);
					} else {
						_yuitest_coverline("gallery-md-model", 359);
self._values = {};

						_yuitest_coverline("gallery-md-model", 361);
facade.parsed = self.parse(response);
						_yuitest_coverline("gallery-md-model", 362);
self.fire(EVT_LOADED, facade);
					}

					_yuitest_coverline("gallery-md-model", 365);
if (Lang.isFunction(callback)) {
						_yuitest_coverline("gallery-md-model", 366);
callback.apply(null, arguments);
					}
				});

				_yuitest_coverline("gallery-md-model", 370);
return self;
			},
			...
			**/
			parse: function (response) {
				_yuitest_coverfunc("gallery-md-model", "parse", 390);
_yuitest_coverline("gallery-md-model", 391);
if (typeof response === 'string') {
					_yuitest_coverline("gallery-md-model", 392);
try {
						_yuitest_coverline("gallery-md-model", 393);
return Y.JSON.parse(response);
					} catch (ex) {
						_yuitest_coverline("gallery-md-model", 395);
this.fire(EVT_ERROR, {
							error : ex,
							response: response,
							src : 'parse'
						...
						_yuitest_coverline("gallery-md-model", 401);
return null;
					}
				}

				_yuitest_coverline("gallery-md-model", 405);
return response;
			},
			...
			**/
			save: function (options, callback) {
				_yuitest_coverfunc("gallery-md-model", "save", 432);
_yuitest_coverline("gallery-md-model", 433);
var self = this;

				_yuitest_coverline("gallery-md-model", 435);
if (Lang.isFunction(options)) {
					_yuitest_coverline("gallery-md-model", 436);
callback = options;
					_yuitest_coverline("gallery-md-model", 437);
options = {};
				} else {_yuitest_coverline("gallery-md-model", 438);
if (!options) {
					_yuitest_coverline("gallery-md-model", 439);
options = {};
				}}

				_yuitest_coverline("gallery-md-model", 442);
self._validate(self.getValues(), function (err) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 9)", 442);
_yuitest_coverline("gallery-md-model", 443);
if (err) {
						_yuitest_coverline("gallery-md-model", 444);
if (Lang.isFunction(callback)) {
							_yuitest_coverline("gallery-md-model", 445);
callback.call(null, err);
						}
						_yuitest_coverline("gallery-md-model", 447);
return;
					}

					_yuitest_coverline("gallery-md-model", 450);
self.sync(self.get(IS_NEW) ? 'create' : 'update', options, function (err, response) {
						_yuitest_coverfunc("gallery-md-model", "(anonymous 10)", 450);
_yuitest_coverline("gallery-md-model", 451);
var facade = {
								options : options,
								response: response,
								src: 'save'
						...
						_yuitest_coverline("gallery-md-model", 457);
if (err) {
							_yuitest_coverline("gallery-md-model", 458);
facade.error = err;

							_yuitest_coverline("gallery-md-model", 460);
self.fire(EVT_ERROR, facade);
						} else {
							_yuitest_coverline("gallery-md-model", 462);
facade.parsed = self.parse(response);

							_yuitest_coverline("gallery-md-model", 464);
self._set(IS_MODIFIED, false);
							_yuitest_coverline("gallery-md-model", 465);
self._set(IS_NEW, false);
							_yuitest_coverline("gallery-md-model", 466);
self._loadedValues = Y.clone(self._values);
							_yuitest_coverline("gallery-md-model", 467);
self.fire(EVT_SAVED, facade);
							_yuitest_coverline("gallery-md-model", 468);
if (facade.parsed) {
								_yuitest_coverline("gallery-md-model", 469);
self.fire(EVT_LOADED, facade);
							}
						}

						_yuitest_coverline("gallery-md-model", 473);
if (Lang.isFunction(callback)) {
							_yuitest_coverline("gallery-md-model", 474);
callback.apply(null, arguments);
						}
					});
				});

				_yuitest_coverline("gallery-md-model", 479);
return self;
			},
			/**
			 ...
			 */
			reset: function() {
				_yuitest_coverfunc("gallery-md-model", "reset", 485);
_yuitest_coverline("gallery-md-model", 486);
this._values = Y.clone(this._loadedValues);
				_yuitest_coverline("gallery-md-model", 487);
this.fire(EVT_RESET);
				_yuitest_coverline("gallery-md-model", 488);
return this;
			},
			/**
			...
			**/
			sync: function (action, options, callback) {
				...
				_yuitest_coverfunc("gallery-md-model", "sync", 514);
_yuitest_coverline("gallery-md-model", 516);
if (Lang.isFunction(callback)) {
					_yuitest_coverline("gallery-md-model", 517);
callback();
				}
			},
			/**
			...
			**/
			validate: function (attrs, callback) {
				_yuitest_coverfunc("gallery-md-model", "validate", 560);
_yuitest_coverline("gallery-md-model", 561);
if (Lang.isFunction(callback))  {
					_yuitest_coverline("gallery-md-model", 562);
callback();
				}
			},
			/**
			...
			**/
			_validate: function (attributes, callback) {
				_yuitest_coverfunc("gallery-md-model", "_validate", 575);
_yuitest_coverline("gallery-md-model", 576);
var self = this;

				_yuitest_coverline("gallery-md-model", 578);
self.validate(attributes, function (err) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 11)", 578);
_yuitest_coverline("gallery-md-model", 579);
if (Lang.isValue(err)) {
						// Validation failed. Fire an error.
						_yuitest_coverline("gallery-md-model", 581);
self.fire(EVT_ERROR, {
						...
						_yuitest_coverline("gallery-md-model", 587);
callback(err);
						_yuitest_coverline("gallery-md-model", 588);
return;
					}

					_yuitest_coverline("gallery-md-model", 591);
callback();
				});
			...
			**/
			toJSON: function () {
				_yuitest_coverfunc("gallery-md-model", "toJSON", 607);
_yuitest_coverline("gallery-md-model", 608);
return this.getValue();
			},
			_isModifiedGetter: function (value, name) {
				_yuitest_coverfunc("gallery-md-model", "_isModifiedGetter", 610);
_yuitest_coverline("gallery-md-model", 611);
name = name.split(DOT);
				_yuitest_coverline("gallery-md-model", 612);
if (name.length > 1) {
					_yuitest_coverline("gallery-md-model", 613);
name = name[1];
					_yuitest_coverline("gallery-md-model", 614);
var ret = {};
					_yuitest_coverline("gallery-md-model", 615);
ret[name] = this._values[name] !== this._loadedValues[name];
					_yuitest_coverline("gallery-md-model", 616);
return ret;
				}
				_yuitest_coverline("gallery-md-model", 618);
return value;
			},
			_isNewGetter: function (value, name) {
				_yuitest_coverfunc("gallery-md-model", "_isNewGetter", 620);
_yuitest_coverline("gallery-md-model", 621);
name = name.split(DOT);
				_yuitest_coverline("gallery-md-model", 622);
if (name.length > 1) {
					_yuitest_coverline("gallery-md-model", 623);
name = name[1];
					_yuitest_coverline("gallery-md-model", 624);
var ret = {};
					_yuitest_coverline("gallery-md-model", 625);
ret[name] = !this._loadedValues.hasOwnProperty(name);
					_yuitest_coverline("gallery-md-model", 626);
return ret;
				}
				_yuitest_coverline("gallery-md-model", 628);
return value;
			},
			_primaryKeysSetter: function (value) {
				_yuitest_coverfunc("gallery-md-model", "_primaryKeysSetter", 630);
_yuitest_coverline("gallery-md-model", 631);
if (this._primaryKeys && this._primaryKeys.length) {
					_yuitest_coverline("gallery-md-model", 632);
return Y.Attribute.INVALID_VALUE;
				}
				_yuitest_coverline("gallery-md-model", 634);
value = new YArray(value);
				_yuitest_coverline("gallery-md-model", 635);
this._primaryKeys = value;
				_yuitest_coverline("gallery-md-model", 636);
return value;
			},
			_primaryKeysGetter: function (value, name) {
				_yuitest_coverfunc("gallery-md-model", "_primaryKeysGetter", 638);
_yuitest_coverline("gallery-md-model", 639);
name = name.split(DOT);
				_yuitest_coverline("gallery-md-model", 640);
if (name.length > 1) {
					_yuitest_coverline("gallery-md-model", 641);
name = name[1];
					_yuitest_coverline("gallery-md-model", 642);
var ret = {};
					_yuitest_coverline("gallery-md-model", 643);
ret[name] = value.indexOf(name) !== -1;
					_yuitest_coverline("gallery-md-model", 644);
return ret;
				}
				_yuitest_coverline("gallery-md-model", 646);
return (value || []).concat();  // makes sure to return a copy, not the original.
	 ...
	 */
	_yuitest_coverline("gallery-md-model", 717);
Y.GalleryModelSimpleUndo = function () {};
	
	_yuitest_coverline("gallery-md-model", 719);
Y.GalleryModelSimpleUndo.prototype = {
		initializer: function () {
			_yuitest_coverfunc("gallery-md-model", "initializer", 720);
_yuitest_coverline("gallery-md-model", 721);
this._lastChange = {};
			_yuitest_coverline("gallery-md-model", 722);
if (this._addPreserve) {
				_yuitest_coverline("gallery-md-model", 723);
this._addPreserve('_lastChange');
			}
			_yuitest_coverline("gallery-md-model", 725);
this.after(EVT_CHANGE, this._trackChange);
			_yuitest_coverline("gallery-md-model", 726);
this.after([EVT_LOADED,EVT_SAVED,EVT_RESET], this._resetUndo);	
		},
		/**
		...
		_trackChange: function (ev) {
			_yuitest_coverfunc("gallery-md-model", "_trackChange", 735);
_yuitest_coverline("gallery-md-model", 736);
if (ev.name && ev.src !== UNDO) {
				_yuitest_coverline("gallery-md-model", 737);
this._lastChange[ev.name] = ev.prevVal;
		 ...
		 */
		_resetUndo: function () {
			_yuitest_coverfunc("gallery-md-model", "_resetUndo", 745);
_yuitest_coverline("gallery-md-model", 746);
this._lastChange = {};
		},
		/**
		 ...
		 */
		undo: function (name) {
			_yuitest_coverfunc("gallery-md-model", "undo", 754);
_yuitest_coverline("gallery-md-model", 755);
var self = this;
			_yuitest_coverline("gallery-md-model", 756);
if (name) {
				_yuitest_coverline("gallery-md-model", 757);
if (self._lastChange[name] !== undefined) {		
					_yuitest_coverline("gallery-md-model", 758);
self.setValue(name, self._lastChange[name], UNDO);
					_yuitest_coverline("gallery-md-model", 759);
delete self._lastChange[name];
				}
			} else {
				_yuitest_coverline("gallery-md-model", 762);
self.setValues(this._lastChange, UNDO);
				_yuitest_coverline("gallery-md-model", 763);
self._lastChange = {};
			}
		}
	};
	 ...
	 */
	_yuitest_coverline("gallery-md-model", 775);
Y.GalleryModelChronologicalUndo = function () {};
	
	_yuitest_coverline("gallery-md-model", 777);
Y.GalleryModelChronologicalUndo.prototype = {
		initializer: function () {
			_yuitest_coverfunc("gallery-md-model", "initializer", 778);
_yuitest_coverline("gallery-md-model", 779);
this._changes = [];
			_yuitest_coverline("gallery-md-model", 780);
if (this._addPreserve) {
				_yuitest_coverline("gallery-md-model", 781);
this._addPreserve('_changes');
			}
			_yuitest_coverline("gallery-md-model", 783);
this.after(EVT_CHANGE, this._trackChange);
			_yuitest_coverline("gallery-md-model", 784);
this.after([EVT_LOADED,EVT_SAVED,EVT_RESET], this._resetUndo);
		},
		/**
		 * Event listener for the after value change event, it tracks changes for each field.  
		 ...
		 */
		_trackChange: function (ev) {
			_yuitest_coverfunc("gallery-md-model", "_trackChange", 793);
_yuitest_coverline("gallery-md-model", 794);
if (ev.src !== UNDO) {
				_yuitest_coverline("gallery-md-model", 795);
this._changes.push(ev.details);
		 ...
		 */
		_resetUndo: function () {
			_yuitest_coverfunc("gallery-md-model", "_resetUndo", 803);
_yuitest_coverline("gallery-md-model", 804);
this._changes = [];
		},
		/**
		 ...
		 */
		undo: function () {
			_yuitest_coverfunc("gallery-md-model", "undo", 810);
_yuitest_coverline("gallery-md-model", 811);
var ev = this._changes.pop();
			_yuitest_coverline("gallery-md-model", 812);
if (ev) {
				_yuitest_coverline("gallery-md-model", 813);
if (ev.name) {
					_yuitest_coverline("gallery-md-model", 814);
this.setValue(ev.name, ev.prevVal, UNDO);
				} else {
					_yuitest_coverline("gallery-md-model", 816);
this.setValues(ev.prevVals, UNDO);
				}
			}
			_yuitest_coverline("gallery-md-model", 819);
if (this._changes.length === 0) {
				_yuitest_coverline("gallery-md-model", 820);
this._set(IS_MODIFIED, false);
			}
		}
	};
	...
	_yuitest_coverline("gallery-md-model", 832);
var INDEX = 'index',
		MR = function () {};
	
	_yuitest_coverline("gallery-md-model", 835);
MR.prototype = {
		/**
		...
		initializer: function () {
			_yuitest_coverfunc("gallery-md-model", "initializer", 844);
_yuitest_coverline("gallery-md-model", 845);
this._shelves = [];
			_yuitest_coverline("gallery-md-model", 846);
this._currentIndex = 0;
			_yuitest_coverline("gallery-md-model", 847);
this._addPreserve('_values','_loadedValues','_isNew','_isModified');
		...
		_shelve: function(index) {
			_yuitest_coverfunc("gallery-md-model", "_shelve", 870);
_yuitest_coverline("gallery-md-model", 871);
if (index === undefined) {
				_yuitest_coverline("gallery-md-model", 872);
index = this._currentIndex;
			}
			_yuitest_coverline("gallery-md-model", 874);
var self = this,
				current = {};
			_yuitest_coverline("gallery-md-model", 876);
YArray.each(self._preserve, function (name) {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 12)", 876);
_yuitest_coverline("gallery-md-model", 877);
current[name] = self[name];
			});
			_yuitest_coverline("gallery-md-model", 879);
self._shelves[index] = current;
		...
		_fetch: function (index) {
			_yuitest_coverfunc("gallery-md-model", "_fetch", 887);
_yuitest_coverline("gallery-md-model", 888);
if (index === undefined) {
				_yuitest_coverline("gallery-md-model", 889);
index = this._currentIndex;
			} else {
				_yuitest_coverline("gallery-md-model", 891);
this._currentIndex = index;
			}
			_yuitest_coverline("gallery-md-model", 893);
var self = this,
				current = self._shelves[index];
				
			_yuitest_coverline("gallery-md-model", 896);
if (Lang.isUndefined(current)) {
				_yuitest_coverline("gallery-md-model", 897);
this._initNew();
			} else {
				_yuitest_coverline("gallery-md-model", 899);
YArray.each(self._preserve, function (name) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 13)", 899);
_yuitest_coverline("gallery-md-model", 900);
self[name] = current[name];
		...
		_addPreserve: function () {
			_yuitest_coverfunc("gallery-md-model", "_addPreserve", 912);
_yuitest_coverline("gallery-md-model", 913);
this._preserve = (this._preserve || []).concat(Array.prototype.slice.call(arguments));
		 ...
		 */
		_initNew: function () {
			_yuitest_coverfunc("gallery-md-model", "_initNew", 921);
_yuitest_coverline("gallery-md-model", 922);
this._values = {};
			_yuitest_coverline("gallery-md-model", 923);
this._loadedValues = {};
			_yuitest_coverline("gallery-md-model", 924);
this._isNew = true;
			_yuitest_coverline("gallery-md-model", 925);
this._isModified = false;
		...
		add: function(values, index) {
			_yuitest_coverfunc("gallery-md-model", "add", 934);
_yuitest_coverline("gallery-md-model", 935);
if (this.get(IS_MODIFIED) || !this.get(IS_NEW)) {
				_yuitest_coverline("gallery-md-model", 936);
this._shelve();
			}
			_yuitest_coverline("gallery-md-model", 938);
index = index || this._shelves.length;
			_yuitest_coverline("gallery-md-model", 939);
this._shelves.splice(index, 0, {});
			_yuitest_coverline("gallery-md-model", 940);
this._currentIndex = index;
			_yuitest_coverline("gallery-md-model", 941);
this._initNew();
			_yuitest_coverline("gallery-md-model", 942);
this.setValues(values, ADD);
		 ...
		 */
		each: function(fn) {
			_yuitest_coverfunc("gallery-md-model", "each", 953);
_yuitest_coverline("gallery-md-model", 954);
var self = this;
			_yuitest_coverline("gallery-md-model", 955);
self._shelve();
			_yuitest_coverline("gallery-md-model", 956);
YArray.each(self._shelves, function (shelf, index) {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 14)", 956);
_yuitest_coverline("gallery-md-model", 957);
self._currentIndex = index;
				_yuitest_coverline("gallery-md-model", 958);
self._fetch(index);
				_yuitest_coverline("gallery-md-model", 959);
if (fn.call(self, index) !== false) {
					_yuitest_coverline("gallery-md-model", 960);
self._shelve(index);
				}
			});
		},
		...
		eachModified:function(fn) {
			_yuitest_coverfunc("gallery-md-model", "eachModified", 974);
_yuitest_coverline("gallery-md-model", 975);
var self = this;
			_yuitest_coverline("gallery-md-model", 976);
self._shelve();
			_yuitest_coverline("gallery-md-model", 977);
YArray.each(self._shelves,  function (shelf, index) {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 15)", 977);
_yuitest_coverline("gallery-md-model", 978);
if (self._shelves[index][IS_MODIFIED]) {
					_yuitest_coverline("gallery-md-model", 979);
self._currentIndex = index;
					_yuitest_coverline("gallery-md-model", 980);
self._fetch(index);
					_yuitest_coverline("gallery-md-model", 981);
if (fn.call(self, index) !== false) {
						_yuitest_coverline("gallery-md-model", 982);
self._shelve(index);
					}
				}
			});
		...
		saveAllModified: function () {
			_yuitest_coverfunc("gallery-md-model", "saveAllModified", 994);
_yuitest_coverline("gallery-md-model", 995);
this.eachModified(this.save);
		 ...
		 */
		_defDataLoaded: function (ev) {
			_yuitest_coverfunc("gallery-md-model", "_defDataLoaded", 1011);
_yuitest_coverline("gallery-md-model", 1012);
var self = this,
				shelves = self._shelves;
			_yuitest_coverline("gallery-md-model", 1014);
if (Lang.isArray(ev.parsed)) {
				_yuitest_coverline("gallery-md-model", 1015);
if (shelves.length && (self.get(IS_MODIFIED) || !self.get(IS_NEW))) {
					_yuitest_coverline("gallery-md-model", 1016);
self._shelve();
				}
				_yuitest_coverline("gallery-md-model", 1018);
YArray.each(ev.parsed, function (values) {
					_yuitest_coverfunc("gallery-md-model", "(anonymous 16)", 1018);
_yuitest_coverline("gallery-md-model", 1019);
shelves.push({
						_values: values,
				...
				_yuitest_coverline("gallery-md-model", 1026);
self._fetch();
				_yuitest_coverline("gallery-md-model", 1027);
if (self._sort) {
					_yuitest_coverline("gallery-md-model", 1028);
self._sort();
				}
			} else {
				_yuitest_coverline("gallery-md-model", 1031);
Y.GalleryModel.prototype._defDataLoaded.apply(self, arguments);
		 ...
		 */
		size: function() {
			_yuitest_coverfunc("gallery-md-model", "size", 1040);
_yuitest_coverline("gallery-md-model", 1041);
var count = 0;
			_yuitest_coverline("gallery-md-model", 1042);
YArray.each(this._shelves, function () {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 17)", 1042);
_yuitest_coverline("gallery-md-model", 1043);
count +=1;
			});
			_yuitest_coverline("gallery-md-model", 1045);
return count;
		},
		/**
		 ...
		 */
		empty: function () {
			_yuitest_coverfunc("gallery-md-model", "empty", 1051);
_yuitest_coverline("gallery-md-model", 1052);
this._shelves = [];
			_yuitest_coverline("gallery-md-model", 1053);
this._currentIndex = 0;
			_yuitest_coverline("gallery-md-model", 1054);
this.reset();
		},
		/**
		...
		_indexSetter: function (value) {
			_yuitest_coverfunc("gallery-md-model", "_indexSetter", 1064);
_yuitest_coverline("gallery-md-model", 1065);
if (Lang.isNumber(value) && value >= 0 && value < this._shelves.length) {
				_yuitest_coverline("gallery-md-model", 1066);
this._shelve(this._currentIndex);
				_yuitest_coverline("gallery-md-model", 1067);
this._currentIndex = value = parseInt(value,10);
				_yuitest_coverline("gallery-md-model", 1068);
this._fetch(value);
				_yuitest_coverline("gallery-md-model", 1069);
return value;
			}
			_yuitest_coverline("gallery-md-model", 1071);
return Y.Attribute.INVALID_VALUE;
		},
		/**
		...
		_indexGetter: function () {
			_yuitest_coverfunc("gallery-md-model", "_indexGetter", 1080);
_yuitest_coverline("gallery-md-model", 1081);
return this._currentIndex;
		 ...
		 */
		_isNewGetter: function (value, name) {
			_yuitest_coverfunc("gallery-md-model", "_isNewGetter", 1094);
_yuitest_coverline("gallery-md-model", 1095);
if (name.split(DOT).length > 1) {
				_yuitest_coverline("gallery-md-model", 1096);
return Y.GalleryModel.prototype._isNewGetter.apply(this, arguments);
			}
			_yuitest_coverline("gallery-md-model", 1098);
return this._isNew;
		...
		_isNewSetter: function (value) {
			_yuitest_coverfunc("gallery-md-model", "_isNewSetter", 1110);
_yuitest_coverline("gallery-md-model", 1111);
return (this._isNew = value);
		 ...
		 */
		_isModifiedGetter:  function (value, name) {
			_yuitest_coverfunc("gallery-md-model", "_isModifiedGetter", 1124);
_yuitest_coverline("gallery-md-model", 1125);
if (name.split(DOT).length > 1) {
				_yuitest_coverline("gallery-md-model", 1126);
return Y.GalleryModel.prototype._isModifiedGetter.apply(this, arguments);
			}
			_yuitest_coverline("gallery-md-model", 1128);
return this._isModified;
		...
		_isModifiedSetter:  function (value) {
			_yuitest_coverfunc("gallery-md-model", "_isModifiedSetter", 1140);
_yuitest_coverline("gallery-md-model", 1141);
return (this._isModified = value);
	...
	_yuitest_coverline("gallery-md-model", 1147);
MR.ATTRS = {
		/**
	...
	_yuitest_coverline("gallery-md-model", 1175);
Y.GalleryModelMultiRecord = MR;
	 ...
	 */
	_yuitest_coverline("gallery-md-model", 1182);
var SFIELD = 'sortField',
	...
	_yuitest_coverline("gallery-md-model", 1188);
SMR.prototype = {
		/**
		 ...
		 */
		initializer: function () {
			_yuitest_coverfunc("gallery-md-model", "initializer", 1205);
_yuitest_coverline("gallery-md-model", 1206);
if (this.get(SFIELD) === undefined) {
				_yuitest_coverline("gallery-md-model", 1207);
this._set(SFIELD, this.get('primaryKeys')[0]);
			}
			_yuitest_coverline("gallery-md-model", 1209);
this._setCompare();
			_yuitest_coverline("gallery-md-model", 1210);
this.after([SFIELD + CHANGE, SDIR + CHANGE], this._sort);
			_yuitest_coverline("gallery-md-model", 1211);
this.after('change', this._afterChange);
		...
		_setCompare: function () {
			_yuitest_coverfunc("gallery-md-model", "_setCompare", 1219);
_yuitest_coverline("gallery-md-model", 1220);
var sortField = this.get(SFIELD),
				sortAsc = this.get(SDIR) === ASC?1:-1,
				compareValue = (Lang.isFunction(sortField)?
					sortField:
					function(values) {
						_yuitest_coverfunc("gallery-md-model", "sortField", 1224);
_yuitest_coverline("gallery-md-model", 1225);
return values[sortField];
					}
				);
			_yuitest_coverline("gallery-md-model", 1228);
this._compare = function(a, b) {
				_yuitest_coverfunc("gallery-md-model", "_compare", 1228);
_yuitest_coverline("gallery-md-model", 1229);
var aValue = compareValue(a._values),
					bValue = compareValue(b._values);

				_yuitest_coverline("gallery-md-model", 1232);
return (aValue < bValue ? -1 : (aValue > bValue ? 1 : 0)) * sortAsc;
		 ...
		 */
		_sort: function() {
			_yuitest_coverfunc("gallery-md-model", "_sort", 1240);
_yuitest_coverline("gallery-md-model", 1241);
this._setCompare();
			_yuitest_coverline("gallery-md-model", 1242);
this._shelve();
			_yuitest_coverline("gallery-md-model", 1243);
this._shelves.sort(this._compare);
			_yuitest_coverline("gallery-md-model", 1244);
this._shelves.splice(this.size());
			_yuitest_coverline("gallery-md-model", 1245);
this._fetch(0);
		},
		/**
		...
		_afterChange: function (ev) {
			_yuitest_coverfunc("gallery-md-model", "_afterChange", 1254);
_yuitest_coverline("gallery-md-model", 1255);
var fieldName = ev.name,
			...
			_yuitest_coverline("gallery-md-model", 1262);
if (fieldName && ev.src !== ADD && (Lang.isFunction(sField) || fieldName === sField)) {
				...
				_yuitest_coverline("gallery-md-model", 1264);
currentShelf = shelves.splice(currentIndex,1)[0];
				_yuitest_coverline("gallery-md-model", 1265);
index = this._findIndex(currentShelf._values);
				_yuitest_coverline("gallery-md-model", 1266);
shelves.splice(index,0,currentShelf);
				_yuitest_coverline("gallery-md-model", 1267);
this._currentIndex = index;
			}
		},
		/**
		...
		_findIndex: function (values) {
			_yuitest_coverfunc("gallery-md-model", "_findIndex", 1278);
_yuitest_coverline("gallery-md-model", 1279);
var shelves = this._shelves,
			...
			_yuitest_coverline("gallery-md-model", 1286);
while (low < high) {
				_yuitest_coverline("gallery-md-model", 1287);
index = Math.floor((high + low) / 2);
				_yuitest_coverline("gallery-md-model", 1288);
switch(cmp(vals, shelves[index])) {
					case 1:
						_yuitest_coverline("gallery-md-model", 1290);
low = index + 1;
						_yuitest_coverline("gallery-md-model", 1291);
break;
					case -1:
						_yuitest_coverline("gallery-md-model", 1293);
high = index;
						_yuitest_coverline("gallery-md-model", 1294);
break;
					default:
						_yuitest_coverline("gallery-md-model", 1296);
low = high = index;
				}
				
			}
			_yuitest_coverline("gallery-md-model", 1300);
return low;
		 ...
		 */
		add: function(values) {
			_yuitest_coverfunc("gallery-md-model", "add", 1310);
_yuitest_coverline("gallery-md-model", 1311);
var shelves = this._shelves,
				index = 0;
				
			_yuitest_coverline("gallery-md-model", 1314);
index = this._findIndex(values);
			_yuitest_coverline("gallery-md-model", 1315);
this._currentIndex = index;
			_yuitest_coverline("gallery-md-model", 1316);
shelves.splice(index, 0, {});
			_yuitest_coverline("gallery-md-model", 1317);
this._initNew();
			_yuitest_coverline("gallery-md-model", 1318);
this.setValues(values, ADD);
			_yuitest_coverline("gallery-md-model", 1319);
this._shelve(index);
		},
		/**
		...
		find: function (value, move) {
			_yuitest_coverfunc("gallery-md-model", "find", 1335);
_yuitest_coverline("gallery-md-model", 1336);
var sfield = this.get(SFIELD),
				index,
				values = {};
			_yuitest_coverline("gallery-md-model", 1339);
if (Lang.isFunction(sfield)) {
				_yuitest_coverline("gallery-md-model", 1340);
return null;
			}
			_yuitest_coverline("gallery-md-model", 1342);
values[sfield] = value;
			_yuitest_coverline("gallery-md-model", 1343);
index = this._findIndex(values);
			_yuitest_coverline("gallery-md-model", 1344);
if (this._shelves[index]._values[sfield] !== value) {
				_yuitest_coverline("gallery-md-model", 1345);
return null;
			}
			_yuitest_coverline("gallery-md-model", 1347);
if (move || arguments.length < 2) {
				_yuitest_coverline("gallery-md-model", 1348);
this.set(INDEX, index);
			}
			_yuitest_coverline("gallery-md-model", 1350);
return index;
		}
	};
	_yuitest_coverline("gallery-md-model", 1353);
SMR.ATTRS = {
		/**
		...
		sortField: {
			validator: function (value){
				_yuitest_coverfunc("gallery-md-model", "validator", 1365);
_yuitest_coverline("gallery-md-model", 1366);
return Lang.isString(value) || Lang.isFunction(value);
		...
		sortDir: {
			validator: function (value) {
				_yuitest_coverfunc("gallery-md-model", "validator", 1376);
_yuitest_coverline("gallery-md-model", 1377);
return value === DESC || value === ASC;
			},
			value: ASC
		}
	};
	_yuitest_coverline("gallery-md-model", 1382);
Y.GalleryModelSortedMultiRecord = SMR;
	 ...
	 */
	_yuitest_coverline("gallery-md-model", 1391);
var PKI = function () {};
	_yuitest_coverline("gallery-md-model", 1392);
PKI.prototype = {
		/**
		 ...
		 */
		add: function(values) {
			_yuitest_coverfunc("gallery-md-model", "add", 1399);
_yuitest_coverline("gallery-md-model", 1400);
if (this.get(IS_MODIFIED) || !this.get(IS_NEW)) {
				_yuitest_coverline("gallery-md-model", 1401);
this._shelve();
			}
			_yuitest_coverline("gallery-md-model", 1403);
this._currentIndex = values[this._primaryKeys[0]];
			_yuitest_coverline("gallery-md-model", 1404);
this._initNew();
			_yuitest_coverline("gallery-md-model", 1405);
this.setValues(values, ADD);
		},
		/**
		 * Default action for the loaded event, checks if the parsed response is an array
		 ...
		 */
		_defDataLoaded: function (ev) {
			_yuitest_coverfunc("gallery-md-model", "_defDataLoaded", 1417);
_yuitest_coverline("gallery-md-model", 1418);
var self = this,
				shelves = self._shelves,
				pk = self._primaryKeys[0];
				
			_yuitest_coverline("gallery-md-model", 1422);
if (Lang.isUndefined(pk)) {
				_yuitest_coverline("gallery-md-model", 1423);
return;
			}	
			_yuitest_coverline("gallery-md-model", 1425);
if (self.get(IS_MODIFIED) || !self.get(IS_NEW)) {
				_yuitest_coverline("gallery-md-model", 1426);
self._shelve();
			}
			_yuitest_coverline("gallery-md-model", 1428);
YArray.each(new YArray(ev.parsed), function (values) {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 18)", 1428);
_yuitest_coverline("gallery-md-model", 1429);
shelves[values[pk]] = {
					_values: values,
					_loadedValues: Y.clone(values),
					isNew: false,
			...
			_yuitest_coverline("gallery-md-model", 1436);
YArray.some(shelves, function (shelf, index) {
				_yuitest_coverfunc("gallery-md-model", "(anonymous 19)", 1436);
_yuitest_coverline("gallery-md-model", 1437);
self._fetch(index);
				_yuitest_coverline("gallery-md-model", 1438);
return true;
			});
		 ...
		 */
		next: function () {
			_yuitest_coverfunc("gallery-md-model", "next", 1450);
_yuitest_coverline("gallery-md-model", 1451);
if (this.get(IS_MODIFIED) || !this.get(IS_NEW)) {
				_yuitest_coverline("gallery-md-model", 1452);
this._shelve();
			}
			_yuitest_coverline("gallery-md-model", 1454);
var shelves = this._shelves,
				index = this._currentIndex + 1, 
				l = shelves.length;
			_yuitest_coverline("gallery-md-model", 1457);
while (index < l && !shelves.hasOwnProperty(index)) {
				_yuitest_coverline("gallery-md-model", 1458);
index +=1;
			}
			_yuitest_coverline("gallery-md-model", 1460);
if (index === l) {
				_yuitest_coverline("gallery-md-model", 1461);
return null;
			}
			_yuitest_coverline("gallery-md-model", 1463);
this._fetch(index);
			_yuitest_coverline("gallery-md-model", 1464);
return index;
		},
		/**
		 * Sugar method added because items might not be contiguous so 
		 ...
		 */
		previous: function () {
			_yuitest_coverfunc("gallery-md-model", "previous", 1474);
_yuitest_coverline("gallery-md-model", 1475);
if (this.get(IS_MODIFIED) || !this.get(IS_NEW)) {
				_yuitest_coverline("gallery-md-model", 1476);
this._shelve();
			}
			_yuitest_coverline("gallery-md-model", 1478);
var shelves = this._shelves,
				index = this._currentIndex - 1;
			_yuitest_coverline("gallery-md-model", 1480);
while (index >= 0 && !shelves.hasOwnProperty(index)) {
				_yuitest_coverline("gallery-md-model", 1481);
index -=1;
			}
			_yuitest_coverline("gallery-md-model", 1483);
if (index === -1) {
				_yuitest_coverline("gallery-md-model", 1484);
return null;
			}
			_yuitest_coverline("gallery-md-model", 1486);
this._fetch(index);
			_yuitest_coverline("gallery-md-model", 1487);
return index;
		}
		
	};
	_yuitest_coverline("gallery-md-model", 1491);
